...
{{- define "eric-enm-cniv-modeling-benchmark.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
Instead we loop over and quote value for each key.
*/ -}}
...
{{- /*
Wrapper functions to set the contexts: annotations, labels
*/ -}}
{{- define "eric-enm-cniv-modeling-benchmark.mergeAnnotations" -}}
  {{- include "eric-enm-cniv-modeling-benchmark.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-enm-cniv-modeling-benchmark.mergeLabels" -}}
  {{- include "eric-enm-cniv-modeling-benchmark.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
